...
class getBlogController2Service extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.2dGVg2B'] ?? $container->load('get_ServiceLocator_2dGVg2BService'))->withContext('App\\Controller\\BlogController', $container));
